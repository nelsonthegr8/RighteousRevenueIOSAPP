...
class HomeViewController: UIViewController {
    ...
    @IBOutlet weak var navSection: UILabel!
...
extension HomeViewController: ChartViewDelegate{
    ...
    func chartValueNothingSelected(_ chartView: ChartViewBase) {
        ...
        //monthlyIncomeAttribute.addAttribute(NSAttributedString.Key.foregroundColor, value: Theme.textColor! , range: allMonthlyIncomeRange)
        ...
        //monthlyExpenseAttribute.addAttribute(NSAttributedString.Key.foregroundColor, value: Theme.textColor! , range: allMonthlyExpenseRange)
        ...
        //monthlyLeftOverRevenueAttribute.addAttribute(NSAttributedString.Key.foregroundColor, value: Theme.textColor! , range: allLeftoverExpenseRange)
        if(leftoverrev < 0){
    ...
    func chartValueSelected(_ chartView: ChartViewBase, entry: ChartDataEntry, highlight: Highlight) {
        ...
        //attribute.addAttribute(NSAttributedString.Key.foregroundColor, value: Theme.textColor! , range: allRange)
